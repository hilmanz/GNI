            	...
            	<div class="col1">
                    <div id="tabs">
                      ...
                      <div class="shorter">
                        ...
                        <form class="pure-form searchBox" action="<?=url('admin/artists/')?>" method="GET" enctype="application/x-www-form-urlencoded">
                        ...
                        <form class="pure-form pure-form-stacked" 
                            ...
                            <fieldset>
                                <div class="pure-control-group">
                                    <input name="name" type="text" placeholder="Nama Seniman" class="pure-input-2-3" >
                                </div>
                                <div class="pure-control-group">
