        ...
        <div class="content">
        	<div class="row">
            	<div class="col1">
                    <div id="tabs">
                      <ul>
                        <li><a href="#tabs-1">Daftar Kondisi</a></li>
                      ...
                      <div class="shorter">
                        ...
                        <form class="pure-form searchBox" action="<?=url('admin/conditions/')?>" method="GET" enctype="application/x-www-form-urlencoded">
                      ...
                      <table class="pure-table pure-table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                    	<a href="<?=url('admin/conditions/edit/'.$data[$i]['id'])?>" class="iconbtn"><span class="icon-pencil">&nbsp;</span></a>
                                    	<a href="<?=url('admin/conditions/delete/'.$data[$i]['id'])?>" class="iconbtn"><span class="icon-trash">&nbsp;</span></a>
                                    </td>
                                </tr>
                                <?php endfor;?>
                            </tbody>
                      ...
                      <div id="tabs-2" class="tabcontent">
                        <form class="pure-form pure-form-stacked" 
                              action="<?=url('admin/conditions/add')?>" 
                              method="POST" 
