...
<div class="page_section" id="dashboard-page">
    <div id="container">
        ...
        <div class="titlebox">
            <h2 class="fl"><span class="icon-newspaper">&nbsp;</span> Jenis Karya Seni</h2>
        </div><!-- end .titlebox -->
        <?php
        $msg = getFlash();
        if(strlen($msg)>0):
        ...
        <div class="content">
        	<div class="row">
            	<div class="col1">
                    <div id="tabs">
                      <ul>
                        <li><a href="#tabs-1">Daftar Jenis</a></li>
                      ...
                      <div class="shorter">
                        ...
                        <form class="pure-form searchBox" action="<?=url('admin/art-types/')?>" method="GET" enctype="application/x-www-form-urlencoded">
                            <input type="text" name="search" value="" placeholder="Ketik jenis karya disini" class="">
                      ...
                      <table class="pure-table pure-table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                    	<a href="<?=url('admin/art-types/edit/'.$data[$i]['id'])?>" class="iconbtn"><span class="icon-pencil">&nbsp;</span></a>
                                    	<a href="<?=url('admin/art-types/delete/'.$data[$i]['id'])?>" class="iconbtn"><span class="icon-trash">&nbsp;</span></a>
                                    </td>
                                </tr>
                                <?php endfor;?>
                            </tbody>
                      ...
                      <div id="tabs-2" class="tabcontent">
                        <form class="pure-form pure-form-stacked" 
                              action="<?=url('admin/art-types/add')?>" 
                              method="POST" 
                              enctype="multipart/form-data">
                            <fieldset>
                                <div class="pure-control-group">
                                    <input name="name" type="text" placeholder="Jenis Karya Seni" class="pure-input-2-3" >
                                </div>
