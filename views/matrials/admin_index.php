        ...
        <div class="content">
        	<div class="row">
            	<div class="col1">
                    <div id="tabs">
                      <ul>
                        <li><a href="#tabs-1">Daftar Jenis MAtrial</a></li>
                      ...
                      <div class="shorter">
                        ...
                        <form class="pure-form searchBox" action="<?=url('admin/matrials/')?>" method="GET" enctype="application/x-www-form-urlencoded">
                            <input type="text" name="search" value="" placeholder="Ketik jenis matrial disini" class="">
                      ...
                      <table class="pure-table pure-table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                    	<a href="<?=url('admin/matrials/edit/'.$data[$i]['id'])?>" class="iconbtn"><span class="icon-pencil">&nbsp;</span></a>
                                    	<a href="<?=url('admin/matrials/delete/'.$data[$i]['id'])?>" class="iconbtn"><span class="icon-trash">&nbsp;</span></a>
                                    </td>
                                </tr>
                                <?php endfor;?>
                            </tbody>
                      ...
                      <div id="tabs-2" class="tabcontent">
                        <form class="pure-form pure-form-stacked" 
                              action="<?=url('admin/matrials/add')?>" 
                              method="POST" 
                              enctype="multipart/form-data">
                            <fieldset>
                                <div class="pure-control-group">
                                    <input name="name" type="text" placeholder="Jenis Matrial" class="pure-input-2-3" >
                                </div>
